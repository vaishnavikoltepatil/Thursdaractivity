...
public class EmployeeServiceTest {
	...
	//	employeeService.addEmployee(123,"nancy",25000,"pune","india");
		...
		Employee emp=Employee.builder().empId(123).
				name("vaishnavi").salary(25000).address(add).build();
	...
	void testDisplayByEmpId() throws GlobalException{
		...
		//assertEquals("vaishnavi", e.getName());
		...
		void testUpdateEmployee()
		{
			...
			assertThat(e.getName()).isEqualTo("gauri");	
		}
		@Test
		@Order(4)
		...
		void testRemoveById()
		{
			...
			//assertEquals("vaishnavi", employeeService.findId(101).getName());
